...
const REGRAS = {
  ...
  rpcmtec: [
    ...
    'O RPCMTec cobre os tres modulos (acervo, mapoteca e orcamento) na numeracao',
    'do documento da Divisao. --anuario baixa o Anuario Estatistico (.ods) do',
    'mesmo mes, que sobe para a DSG no mesmo envio e sai da planilha-semente da',
