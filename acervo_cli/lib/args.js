...
// arquivos de schema). Manter dependencia zero e o que permite rodar o acervo
// num clone recem-baixado sem npm install.
//
// Gramatica aceita:
//   acervo <comando> [subcomando] [posicionais...] [--flag valor] [--booleana]
//   --flag=valor tambem e aceito
//   --flag repetida acumula em array (o --set do editar depende disso)
...
function parse (argv) {
  ...
  // `--set data_edicao=... --set nome=...` perderia o primeiro par em silencio,
  // que e a classe de erro mais cara num comando de escrita.
...
/** Sempre um array, para flags repetiveis (--set, --mi). */
