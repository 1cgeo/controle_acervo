...
const REGRAS = {
  ...
  item: [
    ...
    'OCASIAO, e o que merecer cadastro estavel merece estar no acervo. Em 2026 inteiro',
    'houve UM caso: papel quadriculado para a Central de Tiro.',
    ...
    'pedido explicito.',
    'O item NAO tem forma nem data de entrega desde 2026-07-30: as duas sao do PEDIDO',
    '(forma_entrega_id e data_atendimento). Mandar as chaves antigas no item nao grava',
    'nada, e a resposta traz o aviso de campo ignorado.',
