...
const REGRAS = {
  ...
  item: [
    'Todo item referencia uma versao do acervo (uuid_versao): folha que nao esta',
    'catalogada NAO pode virar item. Nomeie a folha na observacao do pedido e vincule',
    'quando ela entrar no acervo.',
