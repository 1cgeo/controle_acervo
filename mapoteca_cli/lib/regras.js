...
const GERAL = [
  ...
  'de material), operador imprime e faz TUDO de material (lanca movimento no livro e',
  'cadastra o insumo), gerente cadastra pedido, cliente, item e anexo. O administrador',
  'passa em tudo. Publico, sem login, so a consulta por localizador (e o /api e o',
  '/api/login).',
...
const REGRAS = {
  pedido: [
    ...
    'palavras_chave agrupa pedidos do MESMO ASSUNTO, e o filtro --palavra_chave da',
    'listagem casa a etiqueta INTEIRA e sensivel a maiuscula ("excedente" nao acha',
    '"Excedente", e "exced" nao acha "excedente"). E o operador @> do indice GIN:',
    'casar pedaco abandonaria o indice. O filtro SOMA com o ano, nunca o substitui.',
    'O campo e livre, mas o vocabulario foi podado em 2026-08-11 de 34 grafias para',
    'UMA ("excedente"), e a tela sugere as que ja existem. A regra do chefe: o que JA',
    'TEM COLUNA nao vira etiqueta. NAO ponha aqui o cliente, o numero do documento, a',
    'operacao nem o lugar, que ja tem campo proprio. Foi assim que 27 das 34 etiquetas',
    'viraram uso unico, e uso unico nao agrupa nada.',
  ...
  tipo_material: [
    ...
    'Cadastrar material e de OPERADOR, nao de gerente: quem confere a prateleira e',
