...
// `efetivo schema [recurso]` - imprime o contrato de um recurso direto do Joi vivo.
//
...
//
// Vale igual para o efetivo: `efetivo schema efetivo` imprime o contrato da
// passagem e do impedimento sem gastar rede nem credencial.
...
function executar (args) {
  ...
  if (!chave) {
    const linhas = [
      'Recursos de identidade e efetivo do SCA. Detalhe de um deles: efetivo schema <recurso>',
      '',
