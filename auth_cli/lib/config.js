...
//
// Desde 2026-08-02 esse `.valid()` e a UNICA lista de clientes que existe no
// sistema: o catalogo `dgeo.aplicacao` do Auth Server externo nao veio na fusao,
// por decisao do chefe, e `dgeo.login.cliente` e VARCHAR. Ler daqui e o que
...
// e aparece no proprio `auth acessos logins clientes`.
