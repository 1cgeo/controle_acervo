...
/**
 * Create an SVG icon from a path string (for simple inline icons).
...
// Common SVG icon paths (Material Design)
export const ICONS = {
  ...
  category: 'M12 2l-5.5 9h11L12 2zm5.5 11c-2.49 0-4.5 2.01-4.5 4.5s2.01 4.5 4.5 4.5 4.5-2.01 4.5-4.5-2.01-4.5-4.5-4.5zM3 21.5h8v-8H3v8z',
  storage: 'M2 20h20v-4H2v4zm2-3h2v2H4v-2zM2 4v4h20V4H2zm4 3H4V5h2v2zm-4 7h20v-4H2v4zm2-3h2v2H4v-2z',
  dataUsage: 'M13 2.05v3.03c3.39.49 6 3.39 6 6.92 0 .9-.18 1.75-.48 2.54l2.6 1.53c.56-1.24.88-2.62.88-4.07 0-5.18-3.95-9.45-9-9.95zM12 19c-3.87 0-7-3.13-7-7 0-3.53 2.61-6.43 6-6.92V2.05c-5.06.5-9 4.76-9 9.95 0 5.52 4.47 10 9.99 10 3.31 0 6.24-1.61 8.06-4.09l-2.6-1.53C16.17 17.98 14.21 19 12 19z',
  ...
  // A GALERIA de foto e video, do Material "photo_library". Nao e `visibility`:
  // aquele olho quer dizer "ver a ficha", e este botao abre OUTRA coisa -- as
  // fotos e os videos do registro. Dois gestos diferentes com o mesmo icone
  // ensinam a pessoa a clicar no lugar errado.
  ...
  // Chave: a senha em si. Distingue "Resetar senha" do cadeado de "Alternar
  // administrador", que fica ao lado na mesma tela.
