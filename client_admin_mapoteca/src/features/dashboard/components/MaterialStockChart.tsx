// Path: features\dashboard\components\MaterialStockChart.tsx
...
import { StockByLocation } from '@/types/dashboard';

interface MaterialStockChartProps {
  data: StockByLocation[];
}

export const MaterialStockChart = ({ data }: MaterialStockChartProps) => {
  const theme = useTheme();

  // Custom colors for different locations
  const COLORS = [
  ...
  return (
    <Card sx={{ height: 400 }}>
      <CardHeader
        ...
        subheader="Distribuição de materiais por localização"
      />
